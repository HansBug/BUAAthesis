...
生成的png格式图片\footnote{位于./data/diagrams/helloworld.png。}如图\ref{fig-uml-helloworld-png}所示，eps格式图片\footnote{位于./data/diagrams/helloworld.eps。}如图\ref{fig-uml-helloworld-eps}所示。
\begin{figure}[h!]
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=0.75\textwidth]{./data/diagrams/helloworld.puml.png}
		\caption{png格式UML图片}
		\label{fig-uml-helloworld-png}
	\end{minipage}
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=0.75\textwidth]{./data/diagrams/helloworld.puml.eps}
		\caption{eps格式UML图片}
